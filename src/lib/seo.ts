...
export const CLINIC_ADDRESS = {
  streetAddress: "Av. da Liberdade, 150",
...
// Palavras-chave principais agrupadas por intenção
export const KEYWORDS = {
  primary: [
    "fisioterapia lisboa",
    "fisioterapeuta lisboa",
    "clínica fisioterapia lisboa",
    "pilates clínico lisboa",
    "massagem terapêutica lisboa",
  ],
  secondary: [
    "reabilitação física lisboa",
    "fisioterapia desportiva lisboa",
    "avaliação postural lisboa",
    "dores crónicas tratamento",
    "recuperação lesões desportivas",
    "fisioterapia pós-cirúrgica",
    "pilates supervisionado fisioterapeuta",
